...
public class Charger extends GameMob {
    public <T extends Mob> Charger(World world, Location locationToSpawn) {
        ...
        try {
            ...
            getMob().getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(400 + ((Expunge.currentDifficulty.ordinal() * 200)));
            getMob().setHealth(400 + (Expunge.currentDifficulty.ordinal() * 200));
