...
public record Stadium(
    ...
    public static Stadium instance = new Stadium(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

    public Stadium {
        name = "Stadium";
        displayName = ChatUtil.getColor(66, 154, 255) + name();
        startLocation = new Vector(-103, 36, -148);
        startRegion = new BoundingBox(-25, 32, 153, -17, 36, 159);
        endRegion = new BoundingBox(52, 37, 132, 48, 42, 136);
        escapePath = List.of();
        ...
        nextMapCondition = new Movement(new BoundingBox());
        startItems = List.of();
        mapItems = List.of(
                ...
                new ItemRandomizer(-101.5, 37, -145, 1, 1, ItemRandomizer.Preset.TIER2_MELEE),
        ...
        runAtStart = manager -> {
            Dialogue.display(manager.getPlugin(), manager.getPlayers(), DepartureDialogue.STADIUM_OPENING.pickRandom(manager.getPlayers().size()));
            manager.getWorld().getBlockAt(32, 17, 123).setType(Material.REDSTONE_BLOCK);
        };
        runAtEnd = manager -> {};
    }
    ...
    public List<Listener> happenings(JavaPlugin plugin, GameManager gameManager) {
        return List.of(
                new Listener() {
                    ...
                    public void stadiumParkingLotB(PlayerMoveEvent e) {
                        gameManager.getSurvivor(e.getPlayer()).ifPresent(s -> {
                            ...
                            // TODO: what the fuck? gameManager.getDirector().bile(e.getPlayer(), 5);
                ...
                new Listener() {
                    ...
                    public void stadiumEnter(PlayerMoveEvent e) {
                        gameManager.getSurvivor(e.getPlayer()).ifPresent(s -> {
                            ...
                            if (!box.contains(s.getLocation().toVector())) return;
                ...
                new StadiumFinale((CampaignGameManager) gameManager)
        );
    }
}
